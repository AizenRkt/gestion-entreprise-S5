...
CREATE TABLE statut_candidat (
    id_statut_candidat INT AUTO_INCREMENT PRIMARY KEY,
    id_candidat INT,
    statut ENUM('attente', 'accepté') DEFAULT 'attente',
    date_status DATE,
...
CREATE TABLE detail_annonce (
    ...
    id_annonce INT NOT NULL,
    type ENUM('profil','ville','diplome','competence','qualite','objectif') NOT NULL,
...
CREATE TABLE type_scoring (
    ...
    nom VARCHAR(100) NOT NULL --(QCM, entretien RH, entretien dept)
);
