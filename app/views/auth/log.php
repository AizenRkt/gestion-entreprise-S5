...
<head>
    ...
    <title>Login - Mazer Platform</title>
    ...
    <link rel="stylesheet" href="<?= Flight::base() ?>/public/template/assets/compiled/css/auth.css">
</head>
                ...
                <div id="auth-left">
                    ...
                    <form action="<?= Flight::base() ?>/auth/login" method="post">
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="text" name="username" class="form-control form-control-xl" placeholder="Username" required value="hanitra.razaf">
