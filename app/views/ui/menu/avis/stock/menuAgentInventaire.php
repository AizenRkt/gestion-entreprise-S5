<!-- Menu Agent Inventaire - Accès limité aux opérations de comptage -->
<div id="sidebar">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item">
                    <a href="<?= Flight::base() ?>/stock/inventaire/comptage" class='sidebar-link'>
                        <i class="bi bi-pencil-square"></i>
                        <span>Saisie comptage</span>
                    </a>
                </li>

                <li class="sidebar-item">
                    <a href="<?= Flight::base() ?>/stock/inventaire/fiche" class='sidebar-link'>
                        <i class="bi bi-file-earmark-text"></i>
                        <span>Fiche de comptage</span>
                    </a>
                </li>
