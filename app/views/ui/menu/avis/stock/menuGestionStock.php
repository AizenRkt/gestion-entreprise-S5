<!-- Menu Gestionnaire de Stock - Opérations courantes de stock -->
<div id="sidebar">
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item">
                    <a href="<?= Flight::base() ?>/stock/reservations" class='sidebar-link'>
                ...
                <li class="sidebar-item has-sub">
                    ...
                    <ul class="submenu">
                        <li class="submenu-item"><a href="<?= Flight::base() ?>/referentiel/article-famille/list" class="submenu-link">Familles</a></li>
                        <li class="submenu-item"><a href="<?= Flight::base() ?>/referentiel/article/list" class="submenu-link">Articles</a></li>
                    </ul>
                </li>

                <li class="sidebar-item">
                    <a href="<?= Flight::base() ?>/referentiel/fournisseur/list" class='sidebar-link'>
