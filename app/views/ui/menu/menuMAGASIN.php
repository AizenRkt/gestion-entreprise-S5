        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item has-sub">
                    ...
                    <ul class="submenu">
                        <li class="submenu-item"><a href="<?= Flight::base() ?>/ventes" class="submenu-link">Tableau de bord</a></li>
                ...
                <li class="sidebar-item has-sub">
                    ...
                    <ul class="submenu">
                        <li class="submenu-item"><a href="<?= Flight::base() ?>/avis/achat/dashboard" class="submenu-link">Tableau de bord</a></li>
